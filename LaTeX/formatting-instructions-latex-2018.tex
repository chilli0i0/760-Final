...
\begin{center}
  \includegraphics[width=\columnwidth]{lstm_parameters.png}
...
\hline %inserts double horizontal lines
Index & Word1 & Word2 & ... & Word50000 \\ [0.5ex] % inserts table
%heading
\hline % inserts single horizontal line
...
% Write more after we have more results!
...
\begin{center}
\centering
\includegraphics[width=\columnwidth]{Compare_runtime.jpeg}
\captionof{figure}{Runtime of different methods in seconds}
\end{center}

\begin{center}
\centering
\includegraphics[width=\columnwidth]{Compare_mse.jpeg}
...
\begin{center}
\centering
\includegraphics[width=\columnwidth]{NBSVM_unclean_clean.jpeg}
\captionof{figure}{MSE of cleaned and uncleaned dataset}
\end{center}

\begin{center}
\centering
\includegraphics[width=\columnwidth]{NBSVM_runtime_sample.jpeg}
